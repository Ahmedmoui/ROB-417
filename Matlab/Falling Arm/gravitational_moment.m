...
%   f_out = A 1xn cell array containing the gravitational forces on
%       the links;
%   f_torque_out = A 1xn cell array containing the joint torques
%       exerted by the gravitational forces on the individual links
    ...
    for idx = 1:numel(link_vectors)    
        ...
        % 'f', and 'f_torque' to the {idx} entries of the corresponding '_out' 
        % cell arrays            
end